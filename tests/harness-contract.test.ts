...
function fixture(testCase: Case): { root: string; manifest: string; evidenceDir: string } {
  ...
  writeFileSync(
    ...
    [
      ...
      "const claimId = process.env.VEAN_HARNESS_CLAIM_ID;",
      "const controlId = process.env.VEAN_HARNESS_CONTROL_ID;",
      ...
      '  if (claimId !== "claim-demo" || controlId !== "nc-demo") process.exit(2);',
