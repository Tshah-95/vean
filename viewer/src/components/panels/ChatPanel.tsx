    ...
    <div className="flex h-full flex-col">
      <div className="min-h-0 flex-1 overflow-auto px-3 py-3">
        <p className="text-xs leading-relaxed text-muted-foreground">
          Ask vean to edit — tighten a cut, fix a diagnostic, place a clip, render a still. The agent drives
          the same ops you do, so everything is undoable and shows its consequences first.
        </p>
      </div>
