  ...
  return (
    ...
    >
      <div
        ...
        className="flex h-9 flex-shrink-0 items-center gap-0.5 border-b border-sidebar-border px-1.5"
      >
        {DRAWER_TABS.map((t) => {
          ...
          return (
            <button
              ...
              aria-controls="drawer-active-panel"
              className={cn(
      ...
      <div
        id="drawer-active-panel"
        role="tabpanel"
        aria-label={
          view === "settings" ? "Settings" : DRAWER_TABS.find((t) => t.id === view)?.title
        }
