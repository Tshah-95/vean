...
export function ClipBlock({
    ...
    return (
      <div
        style={{
          ...
          top: 0,
          bottom: 0,
          background: "linear-gradient(90deg, var(--vean-bg-hover), color-mix(in srgb, var(--vean-gold) 33%, transparent), var(--vean-bg-hover))",
          borderRadius: 3,
          pointerEvents: "none",
        }}
  ...
  const baseBorder = graphic ? "var(--vean-clip-graphic-edge)" : kind === "audio" ? "var(--vean-clip-audio-edge)" : "var(--vean-clip-video-edge)";
  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow:
          !ghost && selected ? "0 0 0 1px var(--vean-gold), 0 0 8px color-mix(in srgb, var(--vean-gold) 35%, transparent)" : "none",
        borderRadius: 4,
        overflow: "visible",
        display: "flex",
        alignItems: "center",
